...
const DetailsPage = () => {
  ...
  <TableContainer component={Paper}>
    <Table sx={{ minWidth: 650 }} aria-label="simple table">
      <TableHead>
        <TableRow>
          <TableCell>Serial No</TableCell> {/* Updated header */}
          ...
          <TableCell>Soft Deleted</TableCell>
          <TableCell>Barcode Image</TableCell>
        </TableRow>
      </TableHead>
      <TableBody>
        {filteredRackItems.map((rackItem, index) => ( // Added index parameter
          <TableRow
            key={rackItem.rackItemId}
            style={rackItem.isDeleted ? { backgroundColor: 'lightcoral' } : {}}
          >
